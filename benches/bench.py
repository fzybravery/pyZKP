...
from protocols.groth16.setup import setup as groth16_setup
from protocols.groth16.verify import verify as groth16_verify
from protocols.plonk import setup as plonk_setup
from protocols.plonk.prove import prove as plonk_prove
from protocols.plonk.verify import verify as plonk_verify
...
def main() -> None:
    ...
    p.add_argument("--metal-ntt-mode", choices=["v1", "v2"], default="v1")
    p.add_argument("--metal-msm-mode", choices=["v1", "v2"], default="v1")
    args = p.parse_args()
    ...
    runtime_config = RuntimeConfig(
        ...
        metal_ntt_mode=str(args.metal_ntt_mode),
        metal_msm_mode=str(args.metal_msm_mode),
    )
