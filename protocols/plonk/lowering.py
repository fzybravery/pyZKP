...
from protocols.plonk.domain import find_coset_factors, next_power_of_two, roots_of_unity
from protocols.plonk.types import Circuit, Domain, Gate
from crypto.field.fr import FR_MODULUS
from frontend.ir.core import CircuitIR, LinExpr
